 ...
 * **сам екран**, якого створення стосується (нотатки відкривають його своїм
 ...
 * (AGENTS.md §7).
 *
 * **Сторінки тут більше немає, і це рішення.** Сторінка з шаблону — не поле в
 * модалці, а **власний екран**: спершу вибір шаблону з його переглядом, потім
 * текст, який правлять **на самій сторінці** (`/pages/new`,
 * `web-platform-dev/src/pages/user-pages`). Форма з п'яти полів під назвою
 * «Створити» нічого не казала про те, що саме вийде, і вимагала уявити
 * сторінку з підписів полів.
 *
