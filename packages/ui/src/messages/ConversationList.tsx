  ...
  if (conversations.length === 0) {
    return (
      <div className="wb-empty">
        ...
        <p className="wb-empty-text">Ще немає жодної розмови.</p>
        {/* Кажемо, з ким узагалі можна писати: без цього порожній екран —
            глухий кут, бо «кому писати» тут не очевидно. */}
        <p className="wb-empty-text">
          Писати можна тим, із ким ви зв'язані через контакти — хто прийшов за вашим посиланням або
          за чиїм ви прийшли. Відкрийте «Контакти» й надішліть запрошення.
        </p>
      </div>
    );
  }
