 ...
 * чіпляється ні за що. Хештег тому — **не чип** (`.wb-note-tag`, а не
 * `.wb-chip`): у чипа бренди задають свої мірки з `!important`, і рядок
 * хештегів виходив удвічі вищим за рядок із текстом.
 *
