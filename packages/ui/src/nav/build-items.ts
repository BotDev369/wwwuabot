 ...
 *
 * **Це єдиний слот футера без адреси.** «Створити» — дія, а не розділ, і
 * сторінки під нею немає; решта пунктів веде на екран, тож футер ніколи не
 * мовчить про те, що зробить дотик: адреса — це і є його обіцянка.
 */
