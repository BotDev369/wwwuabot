 ...
 *
 * Потрібна там, де всередині одного розділу є свої сторінки: у налаштуваннях
 * теми їх чотири — стиль, мої схеми, спільна бібліотека й налаштування. Перша
  ...
  const content = (
    <>
      ...
      {/* Підпис є завжди: у другій смузі пунктів мало, і саме слово каже, чим
          вони різняться («Мої» / «Публічні» — іконка цього не скаже). */}
