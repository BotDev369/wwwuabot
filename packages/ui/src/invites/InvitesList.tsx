/**
 * Список особистих лінків — картки з готовим посиланням.
 *
 * Картка показує рівно те, що потрібно, щоб надіслати лінк: **підпис** (кому
 * він призначений), **стан** (очікує чи вже приєднався), **сам лінк** і дві
 * дії. Нічого більше: список читають, щоб скопіювати посилання й побачити, хто
 * вже прийшов.
 *
