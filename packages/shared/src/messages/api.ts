...
export interface MessagesApi {
   ...
   * а ця прибирає її **зі списку в того, хто прибрав** (у співрозмовника вона
   * лишається — інакше після «видалити» жодному з двох не було б куди написати).
   * Історію при цьому стерто в обох. Повертається розмова сама — з першим
   * новим повідомленням.
   */
