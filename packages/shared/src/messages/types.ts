...
export interface Conversation {
  ...
  unread: number;
  /**
   * Ненадісланий текст цієї людини — те, що в рядку показано **замість**
   * останнього повідомлення; `null` — чернетки немає.
   *
   * Лежить у рядку списку, а не окремо, бо саме рядок він і замінює: чернетка
   * без рядка була б невидимою, а саме так воно й було видно на телефоні.
   * Заодно вона тримає рядок у списку навіть тоді, коли розмову прибрано: це
   * власна робота людини, і ховати її нема куди.
   */
