 ...
 * заводять руками (ім'я, хештеги, примітки), а лінк — те, чим цей контакт
 * запрошують; він лежить у колонці `contacts.code`. Тому тут немає ні «сутності
 * лінка», ні його списку — є код і те, як його показати.
 *
