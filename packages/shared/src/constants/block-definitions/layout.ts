...
export const layoutBlocks: BlockDefinition[] = [
  block({
    ...
    props: {
      text: s("Текст кнопки"),
      url: s("Посилання (URL)", { format: "uri" }),
      target: e("Відкривати в", ["_blank", "_self"], { default: "_blank" }),
      variant: e("Стиль кнопки", ["primary", "secondary", "outline", "ghost"], {
        default: "primary",
      }),
  ...
  block({
    ...
    props: {
      items: oa(
        "Елементи",
        { text: s("Текст елемента"), icon: s("Іконка"), description: s("Опис") },
        ["text"],
      ),
  ...
  block({
    ...
    props: {
      ...
      columns: oa("Колонки", {
        width: e("Ширина", ["auto", "1/3", "1/2", "2/3"], { default: "auto" }),
      }),
    },
    required: ["columns"],
  ...
  block({
    ...
    props: {
      title: s("Головний заголовок"),
      subtitle: s("Підзаголовок"),
      ...
      buttons: oa(
        "Кнопки CTA",
        {
          text: s("Текст"),
          url: s("Посилання"),
          variant: e("Стиль", ["primary", "secondary"], { default: "primary" }),
        },
        ["text"],
      ),
