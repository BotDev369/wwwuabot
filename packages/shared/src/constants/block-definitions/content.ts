...
export const contentBlocks: BlockDefinition[] = [
  block({
    ...
    props: {
      title: s("Заголовок"), content: s("Текст"),
  ...
  block({
    ...
    props: {
      src: s("URL зображення", { format: "uri" }), alt: s("Альтернативний текст"), caption: s("Підпис"),
  ...
  block({
    type: "richtext", label: "Rich Text", icon: "edit", category: "content",
  ...
  block({
    type: "video", label: "Відео", icon: "video", category: "content",
    description: "Відео-плеєр (YouTube, Vimeo або прямий URL)",
    props: {
      url: s("URL відео"), title: s("Заголовок"), caption: s("Підпис"),
      autoplay: b("Автозапуск"), loop: b("Зациклення"),
    },
    required: ["url"],
    defaultProps: { url: "", title: "", caption: "", autoplay: false, loop: false },
  }),
  block({
    type: "gallery", label: "Галерея", icon: "grid", category: "content",
    description: "Сітка зображень з можливістю перегляду",
    props: {
      images: oa("Зображення", { src: s("URL", { format: "uri" }), alt: s("Альтернативний текст"), caption: s("Підпис") }, ["src"]),
  ...
  block({
    type: "quote", label: "Цитата", icon: "quote", category: "content",
    description: "Блок-цитата з атрибуцією",
    compatibleZones: ["main", "sidebar"],
    props: {
      text: s("Текст цитати"), author: s("Автор"), role: s("Посада / опис автора"),
      style: e("Стиль", ["border-left", "border-right", "filled", "outlined"], { default: "border-left" }),
    },
    required: ["text"],
    defaultProps: { text: "", author: "", role: "", style: "border-left" },
  }),
  block({
    type: "code", label: "Код", icon: "code", category: "content",
    description: "Блок коду з підсвіткою синтаксису",
    compatibleZones: ["main", "sidebar"],
    props: {
      code: s("Код"),
      language: e("Мова", ["javascript", "typescript", "python", "html", "css", "json", "bash", "sql", "plain"], { default: "plain" }),
      title: s("Заголовок"), showLineNumbers: b("Показувати номери рядків"), copyable: b("Кнопка копіювання", { default: true }),
    },
    required: ["code"],
    defaultProps: { code: "", language: "plain", title: "", showLineNumbers: false, copyable: true },
  }),
  block({
    type: "badge", label: "Бейдж", icon: "tag", category: "content",
    description: "Смуга бейджів/міток для статусів та тегів",
    compatibleZones: ["main", "header", "sidebar"],
    props: {
      items: oa("Бейджі", { text: s("Текст"), variant: e("Стиль", ["accent", "green", "red", "yellow", "neutral"], { default: "accent" }) }, ["text"]),
