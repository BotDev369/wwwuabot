...
export const botDomainBlocks: BlockDefinition[] = [
  block({
    type: "user-profile", label: "Профіль", icon: "user", category: "bot-domain",
    ...
    defaultProps: { showAvatar: true, showName: true, showUsername: true, showId: false, layout: "card" },
  }),
  block({
    type: "date-card", label: "Дата", icon: "calendar", category: "bot-domain",
    ...
    defaultProps: { dateSource: "user-birthday", customDate: "", showZodiac: true, showElement: true, showNumerology: true, layout: "full" },
  }),
  block({
    type: "my-dates-table", label: "Таблиця дат", icon: "my-dates", category: "bot-domain",
    ...
    defaultProps: { showSearch: true, showTypeFilter: true, showBulkActions: true, showCreateButton: true },
  }),
  block({
    type: "compare-setup", label: "Введення дат", icon: "compare", category: "bot-domain",
    ...
    defaultProps: { title: "Співставлення дат", description: "Вкажіть дати для аналізу.", maxDates: 10, nextUrl: "/mydate/compare/systems" },
  }),
  block({
    type: "compare-systems", label: "Вибір систем", icon: "eye", category: "bot-domain",
    ...
    defaultProps: { title: "Оберіть системи та параметри", resultUrl: "/mydate", paramKey: "dates", systemKey: "sys", parameterKey: "p" },
  }),
  block({
    type: "compare-table", label: "Таблиця порівняння", icon: "compare", category: "bot-domain",
    ...
    defaultProps: { title: "Співставлення дат", backUrl: "/mydate/compare", paramKey: "dates", systemKey: "sys", parameterKey: "p" },
  }),
  block({
    type: "date-analysis", label: "Аналіз дати", icon: "sparkles", category: "bot-domain",
