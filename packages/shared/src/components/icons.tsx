...
export const icons: Record<IconName, ReactElement> = {
  ...
  /* Рибина: те, що вистрибує з ополонки в «Веселій рибалці». Тіло — замкнена
     дуга, хвіст — трикутник ліворуч, око — точка на голові (праворуч). */
  fish: icon([
    p(
      "M3 12c3-4.6 7.6-6.6 12.2-5.1 1.8.6 3.3 2.2 4.3 5.1-1 2.9-2.5 4.5-4.3 5.1C10.6 18.6 6 16.6 3 12z",
    ),
    p("M3 12 0.5 8.3v7.4L3 12z"),
    c(15.6, 10.4, 0.9),
  ]),

  /* Чобіт — те, що в казці витягли разом з рибою: халява, носок і підошва. */
  boot: icon([
    p(
      "M8 3v9.3a1.3 1.3 0 0 1-.9 1.2L5 14.2A3.2 3.2 0 0 0 3 17.2V19a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-1.6a3 3 0 0 0-3-3h-1a1 1 0 0 1-1-1V3z",
    ),
    l(8, 3, 14, 3),
  ]),
