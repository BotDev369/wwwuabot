...
export const icons: Record<IconName, ReactElement> = {
  ...
  /* Яйце — те, що курки несуть у «Ну, погоди!»: овал, гострий догори. Курку й
     вовка малює сама гра (`NupogodiFigures`): у них по кілька кольорів, а знак
     у реєстрі — один контур одного кольору. */
