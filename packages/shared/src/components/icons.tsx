...
export const icons: Record<IconName, ReactElement> = {
  ...
  /* Стирання — окремий знак від `trash`: у переписці це дві різні дії з
     різними наслідками (почистити історію / прибрати розмову), і один гліф на
     обидві змушував би читати підпис, щоб не натиснути не те. */
  eraser: icon([
    p("m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21"),
    l(22, 21, 7, 21),
    l(5, 11, 14, 20),
  ]),
  ...
  /* Стрічка — картка-публікація: шапка з аватаром і рядки тексту. Це знак
     «Простору», і він СВІЙ, а не `globe`: глобус уже означає «Локації» в
     хабі профілю, а один гліф на дві різні речі змушує читати підпис. */
  feed: icon([
    r(3, 3.5, 18, 17, 3),
    c(7.6, 9.1, 1.8),
