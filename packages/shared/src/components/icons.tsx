...
export type IconName =
  ...
  | "x"
  | "circle"
  // --- Ігри: предмети «каменя, ножиць, паперу» ---
  | "rock"
  | "scissors"
  | "paper"
  | "plus"
...
export const icons: Record<IconName, ReactElement> = {
  ...
  rock: icon([c(12, 12, 7), p("M8.6 9.4c.6-1.3 1.8-2.2 3.2-2.4")]),
  ...
  /* Яйце — те, що курки несуть у «Ну, погоди!»: овал, гострий догори. */
  egg: icon([p("M12 3.4c3.4 0 6 4.3 6 8.4 0 3.6-2.7 6.2-6 6.2s-6-2.6-6-6.2c0-4.1 2.6-8.4 6-8.4z")]),

  /* Курка — господиня курника: голова з гребенем і дзьобом, тіло, хвіст і
     дві ноги. Лінією, а не силуетом: у приладі Електроніки все намальовано
     контуром, і залита пляма на сідалі читалась би як інша гра. */
  hen: icon([
    c(15.4, 7, 2.6),
    p("M14 4.4c-.4-1.1-.2-2.2.6-3 .6 1 .8 1.9.8 2.8"),
    p("M18 7l3 1.1-3 1.2"),
    p(
      "M13.6 9.5c2.8.6 4.6 2.6 4.6 5.1 0 2.7-2.5 4.4-5.9 4.4-3.4 0-6.3-1.6-6.3-4.1 0-2 1.4-3.4 3.4-3.9",
    ),
    p("M7.2 14.6c-1.8-.5-3.4-1.6-4.3-3.1 1.9.2 3.4.8 4.5 1.7"),
    l(10.8, 18.8, 10.8, 21.4),
    l(14.2, 18.8, 14.2, 21.4),
  ]),

  /* Звук у партії: той самий динамік, а «вимкнено» — це хрестик при ньому.
     Дві іконки, а не одна з перечерканням: стан мусить читатись без підпису. */
  "sound-on": icon([
    p("M4 9.5h3.2L12 5.8v12.4L7.2 14.5H4z"),
    p("M15.6 9.2a4.2 4.2 0 0 1 0 5.6"),
    p("M18.2 6.6a7.6 7.6 0 0 1 0 10.8"),
  ]),
  ...
  /* «Три крапки» — дії, які не влазять у рядок. Залитий, а не контурний: три
     контурні кружечки на 16px читались би як три літери «о». */
  more: solid([c(12, 5, 1.9), c(12, 12, 1.9), c(12, 19, 1.9)]),
