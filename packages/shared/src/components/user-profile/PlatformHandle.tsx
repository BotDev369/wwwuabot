 ...
 *
 * **Слів про це немає.** Раніше під іменем стояла порада «так вас бачать інші» —
 * вона не додавала нічого понад підпис самого поля, а в картці займала рядок.
 *
 * **`avatar`** віддає місце круга тому, хто знає, чи є фото (сторінка акаунта).
 * Фото й ім'я стоять в **одній** картці: фото показують іншим так само, як ім'я,
 * і два блоки з одним підписом читались би як дві речі.
 *
