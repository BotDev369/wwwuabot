...
> **Версія:** 2.18 | **Останнє оновлення:** 14.09.2026
>
> **Зміна 2.18:** глобальний **нижній футер** — як у топових застосунків: 5 слотів унизу
> поверх усього, у центрі «+», крайній справа — профіль. Розмітка й стилі спільні
> (`.wb-tabbar*`, `TabBar` з `@wwwuabot/ui/nav`), склад пунктів — свій у кожної оболонки.
>
...
| Футер | `.wb-tabbar-layout`, `.wb-tabbar`, `.wb-tabbar-inner`, `.wb-tabbar-item` (+ `--primary`, `--active`), `.wb-tabbar-icon`, `.wb-tabbar-label`, `.wb-tabbar-plus` |
...
**Глобальний нижній футер** — теж кирпичик: смуга, іконки й «+» у центрі спільні (`TabBar`),
оболонка додає лише склад пунктів. Смуга **фіксована**, тож під нею мусить бути місце
