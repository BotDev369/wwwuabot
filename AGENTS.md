...
> **Версія:** 2.16 | **Останнє оновлення:** 13.09.2026
>
...
> у реєстрі **4** таблиці — рівно як у базі. Журнал — `docs/log/journal-2026-09-13-drop-pages-table.md`.
>
...
> сторінки модерації й шаблонів адмінки, `SiteRenderer`, 9 документів специфікації. Журнал —
> `docs/log/journal-2026-09-13-drop-sites-domain.md`.
>
...
> контенту. Переносити нічого. Деталі — `docs/log/journal-2026-09-13-drop-admin-table.md`.
>
...
> Telegram обрізає задовгий параметр і приймає `@bot` **мовчки**. Деталі —
> `docs/log/journal-2026-09-13-share-deeplink.md`.
>
...
> одна — `slug` (`shared/content/resolve.ts`). Деталі — `docs/log/journal-2026-09-13-slug-entity.md`.
>
> **Зміна 2.11:** контент зводили в **одну таблицю** — спершу як нову `pages`; 13.09.2026 цю
> спробу скасовано (див. 2.16), сховищем лишилась `scenarios`. Деталі —
> `docs/log/journal-2026-09-13-pages-table.md`.
>
...
> посилання з коду збережені); гейт `npm run check:docs`. Деталі —
