...
Правило: **однакова деталь у двох оболонках — це кирпичик, а не «стиль оболонки»**. Новий приватний клас під те, що вже має кирпичик, — дефект. Як саме складені кирпичики (каркас, футер, композер, меню, колекції) — правила 12, 13, 17–20 у `docs/DESIGN_SYSTEM.md`.
