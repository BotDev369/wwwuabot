...
**Глобальний нижній футер** — теж кирпичик: смуга, «комірка» іконки й підсвічення активного
розділу спільні; оболонка додає лише склад пунктів (і solid-пару іконок до них). Смуга **фіксована**, тож під нею мусить бути місце
