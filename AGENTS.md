...
> об'єкта; у §7 додано правило про два сегменти URL. Там же `dependabot.yml` позбувся записів
> для неіснуючих тек (`/bot`, `/web`, `/api`, `/web-admin`) — вони лишились від структури до
> монорепо й читались як покриття, якого немає. Деталі — `docs/log/journal-2026-09-13-sites-tests.md`.
>
