...
> **Версія:** 2.22 | **Останнє оновлення:** 15.09.2026
>
> **Зміна 2.22:** хром — **плоский**: наші смуги малюють ті самі `--chrome-*`, що йдуть клієнту
> (градієнт `--bg-1` — тло контенту); без цього «трохи не сходиться» лишалось би завжди.
