...
> **Версія:** 2.7 | **Останнє оновлення:** 12.09.2026
>
...
- **Масштаб:** 258 файлів / 29 992 рядки в `src/` (+6 модулів замість `sites.service.ts`); разом із тестами — 280 / 32 004. Точні числа, найбільші файли й леджер боргу — `docs/CONSOLIDATION_PLAN.md` §0: це **єдине** місце, де вони живуть, тому тут їх немає.
