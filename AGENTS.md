...
> **Версія:** 2.10 | **Останнє оновлення:** 13.09.2026
>
...
- **Планка в CI:** `npm run check:quality` (окремий крок у тій же джобі `checks`) тримає
  ...
  Відомий борг — `scripts/quality-baseline.mjs`: 3 файли > 400 (план §3.5) і 3 файли-дані.
