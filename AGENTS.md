...
- **Тести:** Vitest, 162 unit-тести. **Гейтять CI** (S-6 закрито 11.09.2026) — червоний тест блокує деплой.
