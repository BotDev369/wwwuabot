...
>
> **Зміна 2.34:** панель «Тема» стала **трьома закритими акордеонами** (`ThemeSection` — новий кирпичик, та сама розмітка, що в рядка кольору: залитий рядок на всю ширину + каретка) і порядок у ній — від загального до часткового: **Стиль** (колишній «Характер»: Apple / Material) зверху, **Кольори теми** (колишні «Твої три кольори») посередині, **Готові палітри** внизу — палітри це швидкий старт, а не налаштування, і зверху вони забирали екран у того, за чим прийшли. Усі акордеони закриті (і секції, і слоти: `openSlot` стартує з `null`), бо відкрита секція — вибір людини, а не стан панелі; пояснення під трьома кольорами прибрано, лишились тільки ті рядки, що щось міняють (порожні слоти й нечитабельний вибір).
>
