...
> **Версія:** 2.24 | **Останнє оновлення:** 16.09.2026
>
...
>
> **Зміна 2.20:** профіль — **один** екран для обох оболонок (`UserProfileCard`) і **ім'я на платформі**
> (`platform_username`): його обирає сам користувач, і саме воно — його ім'я в продукті, а не Telegram-хендл.
> Платформа показує **всі** дані Telegram як є. У панелі той самий екран, але вхід там за паролем —
> свого Telegram-профілю в неї немає: показано акаунт сесії, а профіль людини відкривається за ID.
>
...
> центру лишається, але й без постійного чорного диска: слот дії виділений лише кольором.
>
