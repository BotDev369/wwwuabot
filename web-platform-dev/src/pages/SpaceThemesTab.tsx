/**
 * «Теми» — вкладка Простору: схеми, які люди відкрили для всіх.
 *
 * **Простір — це стрічка всього, що створюють.** Люди, оголошення, сторінки — і
 * теми: схема з відкритим перемикачем «доступна публічно» з'являється тут сама.
 ...
 *
 * **Взяти схему собі — один дотик.** Тут не потрібно нічого копіювати: схема
  ...
  return (
    <SchemeList
      ...
      empty={{
        ...
        hint: "Схема з'являється тут, щойно її автор увімкне «доступна публічно».",
      }}
    />
  );
}
