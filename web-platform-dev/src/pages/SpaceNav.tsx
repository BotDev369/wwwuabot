 ...
 * Обраний пункт і в згорнутому стані видно: акцентний колір пункту і тло
 * плишки (`wb-nav-item--active`) — той самий «тут ти», що у футері, тож стан
 * читається без підпису.
 *
