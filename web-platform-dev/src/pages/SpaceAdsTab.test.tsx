 ...
 * - рядок оголошення — **такий самий рядок, як у решти розділів**: знак виду в
 *   провідній клітинці, назва першою, вид підписом під нею і шеврон напрямку;
...
describe("SpaceAdsTab", () => {
  ...
  it("рядок оголошення — та сама сітка, що в решти розділів", () => {
    ...
    // Провідна клітинка — знак виду (на місці знака гри чи аватара).
    expect(html).toContain("wb-ad-icon");
