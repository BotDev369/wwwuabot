 ...
 *
 * **Один рядок над списком — про те, чого в списку не видно.** Кожна гра тут
 * на одного, і суперник у ній — бот: про це мусить бути сказано, бо інакше
 * людина чекає «запросити гравця», якого ще немає.
 *
...
export function SpaceGamesTab(): ReactElement {
  ...
  return (
    <>
      <p className="wb-text-muted">Поки що кожна гра — на одного: суперник тут бот.</p>
