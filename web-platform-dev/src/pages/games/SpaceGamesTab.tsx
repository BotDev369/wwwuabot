 ...
 *
 * **Знака гри в рядку немає** (правило 23): у контенту Простору іконок не
 * буває — назва гри й так її називає, а знак перед нею був би третім підписом
 * того самого. Провідну клітинку в списках Простору несе лише обличчя
 * людини: воно — вміст, а не знак.
 *
