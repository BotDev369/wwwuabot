 ...
 *
 * **Спочатку назва, і аж потім вид.** Вид оголошення — це підпис у рядку мети, а
 * не шапка над назвою й не знак перед нею: назва мусить читатися першою, як у
 * гри, сторінки чи людини. Свого знака в оголошення немає — у гри є її власний,
 * у людини — обличчя, а оголошення розрізняє **написане** («Подарую · Львів»),
 * і знак перед назвою був би просто ще одним словом, яке треба прочитати.
 *
