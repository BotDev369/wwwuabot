 ...
 * до дотику. Плюс — що «Дати» не повернулись у хаб як друга копія навігації.
 */
...
describe("розділи хабу профілю", () => {
  ...
  it("«Дати» — не розділ хабу: у хабі лише те, чого немає в навігації", () => {
    // Хаб — не друга копія навігації, а те, чого в ній немає місця: друга
    // копія — це двоє дверей в одне місце.
