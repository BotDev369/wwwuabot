 ...
 *
 * **Розділи — вертикально, з підписами.** Горизонтальний сегмент у шапці тут не
 * підходить: у шапці він ділить місце із заголовком і мусить читатись знаками,
 * а ці два розділи обирають **за словом** — «Платформа» й «Телеграм» не
 * вгадуються зі знака. Тому кирпичик інший (`.wb-tabs*`), хоч обидва й
 * перемикачі.
 *
  ...
  return (
    <div className="wb-page">
      ...
      {profile && !loading && !error && (
        <>
          {/* Розділи — вертикальним списком: обидва видно одразу, і місця на
              телефоні вони не з'їдають (два рядки заввишки по планці пальця). */}
