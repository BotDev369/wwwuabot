 ...
 *
 * **Іконок у вмісті картки немає** (правило 23): слово «Застосовано» сказано
 * словом, і галочка біля нього була б другим підписом того самого. Знак
 * лишається кнопкам — вони керування, а не вміст.
 *
  ...
  return (
    <div className="wb-theme-scheme" style={look}>
      <div className="wb-theme-scheme-head">
        ...
        {applied && (
          <span className="wb-badge wb-badge-accent wb-theme-scheme-flag">Застосовано</span>
        )}
      </div>
