 ...
 * губилися серед них. Тепер «+» веде на `/create` (хаб «Створити»), і там
 * кожен пункт має **дві дії**: «подивитись» відкриває екран розділу, а
 * «створити» — форму **поверхнею на хабі**, без переходу (перехід це окрема
 * кнопка). Сам екран розділу свою форму теж уміє — за `?new=1`
