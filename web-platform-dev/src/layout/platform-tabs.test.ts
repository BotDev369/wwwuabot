...
describe("склад футера", () => {
  ...
  it("«+» веде в хаб «Створити», а не відкриває поверхню", () => {
    // Створення живе на своїх екранах і в хабі (поверхнею на ньому), а слот
    // відкриває список входів: інакше дотик не має адреси, а шість власних
    // екранів людини ховаються в хабі профілю, де їх не шукають.
