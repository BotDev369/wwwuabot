...
export function ProfileMenu({ onClose }: ProfileMenuProps): ReactElement {
  ...
  return (
    <MenuModal
      ...
      // Дві картки акаунта — **під** пунктами й тільки в списку: у панелі
      // теми вони займали б місце й не мали б до неї жодного стосунку, а на
      // списку вони стоять у зоні пальця — рука дістає їх не прицілюючись.
      footer={
        view === "list" ? (
          <ProfileAccountCards
            user={profile}
