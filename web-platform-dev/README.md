...
Маршрут рівно один, і це не спрощення: адреса сегментами — це адреса рядка `scenarios`,
а хвіст адреси — його параметри. Другої навігації по тому самому контенту (ієрархії
«сайтів» зі своїми таблицями) не існує — інакше правило «яка сторінка для цього URL»
жило б у двох місцях одразу.
